...
def parse_arguments():
    ...
    parser.add_argument("--path_in", type=str, default="/home/data_sata/KITTI-360")
    parser.add_argument("--path_out", type=str, default="./data/k360")
    parser.add_argument("--scene_name", type=str, default="2013_05_28_drive_0000_sync")
    ...
    parser.add_argument(
        "--cell_dist", type=int, default=10, help="The minimum distance between two cells"
    )
    parser.add_argument("--shift_cells", action="store_true")
    parser.add_argument("--grid_cells", default=True)

    parser.add_argument("--pose_dist", type=int, default=10)
    parser.add_argument("--pose_count", type=int, default=2)
    parser.add_argument("--shift_poses", default=True)
    ...
    os.makedirs(osp.join(args.path_out, "objects"), exist_ok=True)
    os.makedirs(osp.join(args.path_out, "cells"), exist_ok=True)
    os.makedirs(osp.join(args.path_out, "poses"), exist_ok=True)
